...
mkdir ./tests/STARIndex

# run star index and store in new directory
star --runMode genomeGenerate --genomeFastaFiles ./tests/test.fa --sjdbGTFfile ./tests/test.gtf --genomeDir ./tests/STARIndex --genomeSAindexNbases 5
